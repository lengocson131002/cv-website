...
export const experiment = [
  ...
  {
    organization: "ONBRAND CORPORATION - Providing e-commerce services to businesses, corporations, manufacturers, specifically Amazon selling execution service",
...
export const personalSkills = {
  skills: [
    ...
    },
    {
      ...
      description: "Flexibly and actively analyzing, finding root cause of problem. Being interested and passionate about building an end-to-end product development cycle (Build, Measure, Learn)"
    },
    {
      name: "Research",
      description: "Researching and analyzing product vision, business domain, competitive, market to scope out the right features, define the strategy for new product development"
    },
    {
      name: "Communication",
      description: "Experience to engage with Engineering, Testing team to delivery the right output at the right time"
    },
    {
    ...
    {
      name: "Organization",
      description: "Knowledge and experience in product development phases. \nUnderstanding of software process model such as: Waterfall, Agile "
    },
    {
      name: "Others",
...
export const projects = [
  {
    ...
    field: "Chat bot",
    description: "AI Chatbot combines with natural language processing to understand user intent, recognize product images, thereby providing information quickly and efficiently. \n" +
      "Main Scenarios:\n" +
      " - Image recognition\n" +
